...
public class CommentServiceImpl implements ICommentService {
    ...
    public CommentDTO updateComment(CommentDTO commentDTO, Integer cmtId, Principal currentUser) {
        User userFind = getCurrentUser(currentUser);
        Post postFind = postRepository.findPostById(commentDTO.getPostId());
        var cmtFind = commentRepository.findById(cmtId).orElseThrow(() -> new ResourceNotFoundException("Not found with comment ID"));
    ...
    public CommentDTO getCommentById(Integer id) {
        var cmtFind = commentRepository.findById(id).orElseThrow(() -> new ResourceNotFoundException("Not found with comment ID"));
