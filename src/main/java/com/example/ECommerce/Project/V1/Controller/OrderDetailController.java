...
public class OrderDetailController {
    ...
    @GetMapping("/{id}")
    public OrderDetailDTO getOrderById(@PathVariable UUID id) {
    ...
    @PutMapping("/{id}")
    public OrderDetailDTO updateOrder(@PathVariable UUID id, @RequestBody OrderDetailDTO orderDetailDTO) {
