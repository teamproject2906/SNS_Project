        ...
        <div className="space-y-6">
          {favouriteItems.length === 0 ? (
            ...
            favouriteItems.map((product) => (
              <div
                key={product.id}
                className="flex flex-col sm:flex-row justify-between sm:items-center border-b pb-6 gap-5"
              >
                ...
                <div className="flex flex-row justify-end items-center sm:flex-col sm:items-end space-y-2 space-x-2">
                  <Link
                    to={`/products/${product.id}`}
                    state={{ productCode: product.productCode }}
                    className="px-4 py-2 bg-black text-white hover:bg-gray-800 transition-colors whitespace-nowrap"
                  >
                    Chi tiết sản phẩm
                  </Link>
                  <button
