...
function Cart() {
  ...
  const [products, setProducts] = useState([
    {
      id: 1,
      name: "Áo bomber da rắn - XL",
      price: 1600000,
      quantity: 1,
      imageUrl:
        "https://pos.nvncdn.com/eb4d49-63924/ps/20250121_OEl83gYeOZ.jpeg",
    },
    {
      id: 2,
      name: "Quần wide pants đồng công RED waxed - XL",
      price: 1100000,
      quantity: 1,
      imageUrl:
        "https://pos.nvncdn.com/eb4d49-63924/ps/20241227_pRfDe8qR9j.jpeg",
    },
  ]);
      ...
      <div className="flex justify-between space-x-8">
        ...
        <div className="w-2/5 bg-white p-8 shadow-lg">
          ...
          <div className="mt-8 w-full">
            ...
            <button className="w-full py-3 mt-4 border border-gray-400 text-gray-600 text-lg">
              TIẾP TỤC MUA HÀNG
            </button>
          </div>
        </div>
