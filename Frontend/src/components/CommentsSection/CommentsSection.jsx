  ...
  const [comments, setComments] = useState([
    {
      ...
      date: "2025-02-25",
      content: "Sản phẩm rất tốt, giao hàng nhanh chóng! Sản phẩm rất tốt, giao hàng nhanh chóng! Sản phẩm rất tốt, giao hàng nhanh chóng!",
      rating: 5,
      likes: 12,
      liked: false,
      expanded: false,
        ...
        {comments.map((comment, index) => (
          <div key={index} className="commentItem border-t pt-4 mt-4">
            ...
            <div className="commentContent mt-2">
              <p>
                {comment.expanded || comment.content.length <= 100 ? comment.content : `${comment.content.substring(0, 100)}...`}
            ...
            <div className="flex items-center justify-between mt-2">
              <button 
                className={`text-sm flex items-center gap-1 ${comment.liked ? 'text-red-500' : 'text-gray-500'} hover:text-red-700`} 
