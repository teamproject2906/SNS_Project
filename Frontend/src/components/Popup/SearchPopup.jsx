...
import PostCard from "../../pages/SocialFeedPage/component/PostCard/PostCard";
					...
					{loading ? (
						...
						<>
							<div className="text-xs text-gray-500 mb-4 bg-gray-100 p-2 rounded-lg">
								<p>
									Lưu ý: Admin có thể xem cả bài viết đã xóa (dấu đỏ)
									và chưa xóa (dấu xanh). Người dùng thường chỉ xem
									được bài viết chưa xóa.
								</p>
							</div>
